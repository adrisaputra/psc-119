...
INSERT INTO `menu_accesses` VALUES (1,1,4,1,1,1,1,1,1,'2022-01-13 03:02:25','2022-01-13 03:02:25'),(7,1,5,1,1,1,1,1,1,'2022-01-14 09:59:17','2022-01-14 09:59:17'),(8,1,6,1,1,1,1,1,1,'2022-01-14 10:23:01','2022-01-17 03:18:37'),(13,1,7,1,1,1,1,1,1,'2022-01-17 03:00:28','2022-01-17 03:00:28'),(14,2,7,1,1,1,1,1,1,'2022-01-17 03:11:56','2022-01-17 03:11:56'),(15,1,13,1,1,1,1,1,1,'2022-02-18 01:25:25','2022-02-18 01:25:25'),(16,1,14,1,1,1,1,1,1,'2022-03-02 02:40:51','2022-03-02 02:40:51'),(18,3,4,1,1,0,1,1,1,'2022-03-02 07:56:59','2022-03-07 03:18:09'),(22,1,15,1,1,1,1,1,1,'2022-05-23 22:44:19','2022-05-23 22:44:19'),(23,1,16,1,1,1,1,1,1,'2022-05-24 13:51:12','2022-05-24 13:51:12'),(24,1,17,1,1,1,1,1,1,'2022-05-25 08:02:20','2022-05-25 08:02:20'),(25,1,18,1,1,1,1,1,1,'2022-06-03 03:01:40','2022-06-03 03:01:40'),(26,1,19,1,1,1,1,1,1,'2022-06-07 09:15:27','2022-06-07 09:15:27');
...
INSERT INTO `menus` VALUES (4,'Pengaturan','#','fa fa-cogs',15,NULL,1,1,1,'2022-01-12 03:05:31','2022-06-03 03:00:35'),(5,'Log Activity','log','fa fa-circle-notch',14,NULL,2,1,1,'2022-01-14 09:59:00','2022-06-03 03:00:56'),(6,'Data Pegawai','pegawai','fa fa-list',2,NULL,2,1,1,'2022-01-14 10:22:35','2022-02-18 01:18:18'),(7,'Rekapitulasi','#','fa fa-database',1,NULL,2,1,1,'2022-01-15 09:31:03','2022-03-07 02:41:59'),(13,'Report','#','fa fa-list',6,NULL,2,1,1,'2022-02-18 01:16:32','2022-05-25 08:01:57'),(14,'Kirim Email','email','fa fa-envelope',8,NULL,2,1,1,'2022-03-02 02:38:46','2022-05-23 22:43:02'),(15,'Dropzone','dropzone','fa fa-image',3,NULL,2,1,1,'2022-05-23 22:41:29','2022-05-23 22:43:55'),(16,'Database','database','fa fa-database',4,NULL,2,1,1,'2022-05-24 13:50:50','2022-05-24 13:50:50'),(17,'PDF Reader','pdf_reader','fa fa-file',5,NULL,2,1,1,'2022-05-25 08:02:02','2022-05-25 08:02:34'),(18,'Maps','maps','fa fa-map',9,NULL,2,1,1,'2022-06-03 03:01:21','2022-06-03 03:02:25'),(19,'Hierarki','#','fa fa-list',10,NULL,2,1,1,'2022-06-07 09:12:48','2022-06-07 09:13:13');
...
INSERT INTO `offices` VALUES (2,'SEKRETARIAT DAERAH','Komplek Perkantoran Kel. Wanggudu Kec. Asera Kab. Konawe Utara','2022-06-08 05:28:37','2022-06-08 05:28:37');
...
--
-- Table structure for table `position_classes`
--

DROP TABLE IF EXISTS `position_classes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `position_classes` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `position_class_name` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `position_classes`
--

LOCK TABLES `position_classes` WRITE;
/*!40000 ALTER TABLE `position_classes` DISABLE KEYS */;
INSERT INTO `position_classes` VALUES (1,'Sekretaris Daerah',1,'2022-06-08 05:04:54','2022-06-08 05:04:54'),(2,'Asisten Sekretaris Daerah, Inspektur Daerah, Kepala BAPPEDA, BKAD dan BAPENDA',1,'2022-06-08 08:53:01','2022-06-08 08:53:01');
/*!40000 ALTER TABLE `position_classes` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `positions` (
  ...
  `position_leader` int(11) DEFAULT NULL,
  `position_class_id` bigint(20) unsigned NOT NULL,
  `office_id` bigint(20) unsigned NOT NULL,
  `user_id` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `positions_position_class_id_foreign` (`position_class_id`),
  KEY `positions_office_id_foreign` (`office_id`),
  CONSTRAINT `positions_office_id_foreign` FOREIGN KEY (`office_id`) REFERENCES `offices` (`id`),
  CONSTRAINT `positions_position_class_id_foreign` FOREIGN KEY (`position_class_id`) REFERENCES `position_classes` (`id`)
...
INSERT INTO `positions` VALUES (2,'Sekretaris Daerah',NULL,1,2,1,'2022-06-08 07:05:54','2022-06-08 07:05:54'),(3,'Asisten Pemerintahan Umum dan Kesejahteraan Rakyat',NULL,2,2,1,'2022-06-08 08:53:26','2022-06-08 08:53:26'),(4,'Asisten Perekonomian dan Pembangunan',NULL,2,2,1,'2022-06-08 08:53:38','2022-06-08 08:53:38'),(5,'Asisten Administrasi Umum',NULL,2,2,1,'2022-06-08 08:53:48','2022-06-08 08:53:48');
...
INSERT INTO `sessions` VALUES ('RauFwbkMLxIEDD4LMSYwXLCkt3dgUdTiN5lZmbuh',1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/102.0.0.0 Safari/537.36','',1654684075);
...
INSERT INTO `settings` VALUES (1,'CORE LARAVEL','CORE','16354773231.png','16354769112.png','16354882883.jpg',NULL,'AIzaSyDk5azS8gZ2aDInOTqyPv7FmB5uBlu55RQ','default','skin-green-light',1,'2021-10-29 02:58:27','2022-06-04 13:38:43');
...
INSERT INTO `sub_menu_accesses` VALUES (25,1,7,9,1,1,1,1,1,1,'2022-01-17 03:07:17','2022-01-17 03:07:17'),(26,2,7,9,1,1,1,1,1,1,'2022-01-17 03:12:16','2022-01-17 03:12:16'),(27,1,13,11,1,1,1,1,1,1,'2022-02-18 01:25:42','2022-02-18 01:25:42'),(28,1,13,12,1,1,1,1,1,1,'2022-02-18 01:25:54','2022-02-18 01:25:54'),(40,1,4,8,1,1,1,1,1,1,'2022-03-08 01:26:36','2022-03-08 01:26:37'),(41,1,4,6,1,1,1,1,1,1,'2022-03-08 01:27:50','2022-03-08 01:27:50'),(42,1,4,7,1,1,1,1,1,1,'2022-03-08 01:28:05','2022-03-08 01:28:05'),(44,1,19,16,1,1,1,1,1,1,'2022-06-07 09:15:44','2022-06-07 09:15:44'),(45,1,19,17,1,1,1,1,1,1,'2022-06-08 03:32:52','2022-06-08 03:32:52');
...
INSERT INTO `sub_menus` VALUES (6,4,'User','user','fa-circle-notch',1,NULL,1,1,'2022-01-12 05:42:20','2022-01-14 12:01:44'),(7,4,'Menu','menu','fa-circle-notch',3,NULL,1,1,'2022-01-12 05:43:01','2022-01-12 05:43:01'),(8,4,'Group','group','fa-circle-notch',2,NULL,1,1,'2022-01-12 05:43:18','2022-01-12 05:43:18'),(9,7,'Grafik','rekapitulasi_jumlah_pegawai',NULL,1,NULL,1,1,'2022-01-15 09:39:32','2022-01-15 09:39:32'),(11,13,'Excel','report_excel',NULL,1,NULL,1,1,'2022-02-18 01:16:58','2022-02-18 01:16:58'),(12,13,'PDF','report_pdf',NULL,2,NULL,1,1,'2022-02-18 01:17:10','2022-02-18 01:17:10'),(16,19,'OPD','office',NULL,3,NULL,1,1,'2022-06-07 09:14:23','2022-06-07 09:14:23'),(17,19,'Kelas Jabatan','position_class',NULL,2,NULL,1,1,'2022-06-08 03:30:10','2022-06-08 03:30:10');
...
-- Dump completed on 2022-06-08 18:28:01
