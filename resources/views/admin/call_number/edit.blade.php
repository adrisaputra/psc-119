...
@section('konten')
    ...
    <div id="main">
      <div class="row">
		...
		<form action="{{ url('/'.Request::segment(1).'/edit/'.Crypt::encrypt($call_number->id)) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
		{{ csrf_field() }}
							...
							<div class="row">
								<form class="row">
									...
									<div class="input-field col s12">
											...
											<input type="text" id="phone_number" name="phone_number" value="{{ $call_number->phone_number }}" style="@if ($errors->has('phone_number'))border-bottom: 2px solid #ff5252;@else color: black; @endif">
										...
										<div class="input-field col s12">
											...
											<textarea class="materialize-textarea" id="description" placeholder="Keterangan" name="description">{{ $call_number->description }}</textarea>
