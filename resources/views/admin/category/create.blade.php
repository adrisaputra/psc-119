								...
								<form class="row">
									...
									<div class="col s12">
										...
										<div class="input-field col s12">
											<label for="name">{{ __('Nama Kategori') }} <span class="required" style="color: #dd4b39;">*</span></label>
										...
										<div class="input-field col s12">
											...
											<input type="text" id="text" name="text" value="{{ old('text') }}" style="@if ($errors->has('text'))border-bottom: 2px solid #ff5252;@else color: black; @endif">
