								...
								@if ($message = Session::get('status2'))
									<div class="col s12">
										<div class="card-alert card red">
											<div class="card-content white-text">
											<p style="font-size:24px"><i class="icon fa fa-check"></i> Ditolak !</p>
											<p>{{ $message }}</p>
											</div>
										</div>
									</div>
									...
									<tbody>
										...
										<tr>
											...
											<td>
												...
												@if ($v->handling->status=="accept")
													<td><span class="new badge blue" data-badge-caption="Diterima&nbsp;Petugas"></span></th>
												@elseif ($v->handling->status=="reject")
													<td><span class="new badge red" data-badge-caption="Ditolak&nbsp;Petugas"></span></th>
												@elseif ($v->handling->status=="done")
													<td><span class="new badge green" data-badge-caption="Selesai"></span></th>
												@else
													<td><span class="new badge cyan" data-badge-caption="Belum&nbsp;Diproses"></span></th>
												@endif
											<td>
												<div class="col s12 m12 l12" style="display: block;padding-top:7px">
														
													<a class="mb-12 btn waves-effect waves-light cyan darken-1 btn-small btn-block" href="{{ url('/officer/emergency_detail/'.Crypt::encrypt($v->handling->user_id).'/'.Crypt::encrypt($v->id) ) }}" style="padding-bottom:10px">Detail</a>
												</div>
											</td>
										</tr>
