...
@section('konten')
    ...
    <div id="main">
      <div class="row">
		...
		<form action="{{ url('/'.Request::segment(1).'/edit/'.Crypt::encrypt($subdistrict->id)) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
		{{ csrf_field() }}
								...
								<form class="row">
									...
									<div class="col s12">
										...
										<div class="input-field col s12">
											...
											<input type="text" id="name" name="name" value="{{ $subdistrict->name }}" style="@if ($errors->has('name'))border-bottom: 2px solid #ff5252;@else color: black; @endif">
