...
<script type="text/javascript">
	...
	var myOptions = {
		...
		map = new google.maps.Map(document.getElementById("googleMap"), myOptions);
			...
			@php 
				$lat_long1 = explode(", ", $complaint->coordinate_officer); 
				$lat_long2 = explode(", ", $complaint->coordinate_citizen); 
			@endphp

			const dakota = {lat: {{ $lat_long1[0] }}, lng: {{ $lat_long1[1] }} };
			const frick = {lat: {{ $lat_long2[0] }}, lng: {{ $lat_long2[1] }} };
			...
			var icons = {
				...
				// URL
				'{{ asset('images/icon_aduan/mini_ambulance.png') }}',
				// (width,height)
